                ...
                <div className="institute-list">
                        ...
                        <div className="row">
                                ...
                                <div className="col-sm-4">
                                        <MDBBtn class="button-style3" onClick={ addAcademy }>Add Academy</MDBBtn>
                                </div>
                        </div>
                        <div className="row">
                                        ...
                                        <div className="institute-preview col-sm-4" key={ institute.instituteId }>
                                                ...
                                                <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
                                                        ...
                                                        <MDBCardBody>
                                                                ...
                                                                <div className="row">
                                                                <MDBBtn class="button-style1" onClick={()=>editInstitute(institute)}>Edit</MDBBtn><pre>  </pre>
                                                                <MDBBtn class="button-style2" onClick={()=>deleteInstitute(institute.instituteId)}>Delete</MDBBtn>
                                                                </div>
                                                        </MDBCardBody>
                                                </MDBCard>
                                        </div>
