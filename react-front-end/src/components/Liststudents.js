                ...
                <div className="student-list">
                        ...
                        <div className="row">
                                ...
                                <div className="col-sm-4">
                                        <MDBBtn class="button-style3" onClick={ addStudent }>Add Student</MDBBtn>
                                </div>
                        </div>
                        <div className="row">
                                        ...
                                        <div className="student-preview col-sm-4" key={ student.studentId }>
                                                ...
                                                <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
                                                        ...
                                                        <MDBCardBody>
                                                                ...
                                                                <div className="row">
                                                                <MDBBtn class="button-style1" onClick={()=>editStudent(student)}>Edit</MDBBtn><pre>  </pre>
                                                                <MDBBtn class="button-style2" onClick={()=>deleteStudent(student.studentId)}>Delete</MDBBtn>
                                                                </div>
                                                        </MDBCardBody>
                                                </MDBCard>
                                        </div>
