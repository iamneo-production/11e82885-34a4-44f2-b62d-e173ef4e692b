                ...
                <div className="course-list">
                        ...
                        <div className="row">
                                ...
                                <div className="col-sm-4">
                                        <MDBBtn class="button-style3" onClick={ addCourse }>Add Course</MDBBtn>
                                </div>
                        </div>
                        <div className="row">
                        {  courses.map((course)=>(
                                <div className="course-preview col-sm-4" key={ course.courseId }>
                                        ...
                                        <MDBRipple rippleColor='light' rippleTag='div' className='bg-image hover-overlay'>
                                                ...
                                                <MDBCardBody>
                                                        ...
                                                        <div className="row">
                                                                <MDBBtn class="button-style1" onClick={()=>editCourse(course)}>Edit</MDBBtn><pre>  </pre>
                                                                <MDBBtn class="button-style2" onClick={()=>deleteCourse(course.courseId)}>Delete</MDBBtn>
                                                                </div>
                                                </MDBCardBody>
                                        </MDBCard>
                                </div>
